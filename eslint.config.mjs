        ...
        'error',
        {
          patterns: [
            ...
            },
            {
              group: ['**/*.css', '**/*.css?*'],
              message:
                'Do not import CSS directly, see https://github.com/Alan-Cusack/blockexpanse/issues/525',
              allowTypeImports: false,
            },
            {
              group: [packageName],
            ...
            {
              group: ['@blockexpanse/affine', '@blockexpanse/affine/**'],
