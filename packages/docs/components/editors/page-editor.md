...
<iframe src="https://try-blockexpanse.vercel.app/starter/?init" frameborder="no" width="100%" height="500"></iframe>
...
Like all BlockExpanse editors, the editor UI is entirely composed of the combination of [block specs](../../guide/block-spec). A specialized [root block](../blocks/root-block) spec serves as the root node of the document and implements all top-level document UI, with main widgets also mounted on the Accordingly, commonly used editing APIs are provided in the page service.
...
- [`PageEditor`](/api/@blockexpanse/presets/classes/PageEditor.html)
- [`PageRootService`](/api/@blockexpanse/blocks/classes/PageRootService.html)
