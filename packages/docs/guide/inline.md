...
You can use `InlineEditor` without other BlockExpanse dependencies:

```ts
import * as Y from 'yjs';
import { InlineEditor } from '@blockexpanse/inline';
...
The [inline editor playground](https://try-blockexpanse.vercel.app/examples/inline/)
is used for online testing and you can also check out the [source code](https://github.com/Alan-Cusack/blockexpanse/tree/master/packages/playground/examples/inline) in its repository.
