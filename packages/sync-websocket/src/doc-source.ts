/**
 * @file WebSocket DocSource - syncs Yjs document updates over WebSocket.
 *
 * Vendored from packages/playground/apps/_common/sync/websocket/doc.ts.
 * Implements the `DocSource` interface from @blockexpanse/sync.
 */

import type { DocSource } from '@blockexpanse/sync';
