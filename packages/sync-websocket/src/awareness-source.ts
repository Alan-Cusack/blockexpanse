/**
 * @file WebSocket AwarenessSource - syncs user presence (cursors, selections)
 * over WebSocket.
 *
 * Vendored from packages/playground/apps/_common/sync/websocket/awareness.ts.
 * Implements the `AwarenessSource` interface from @blockexpanse/sync.
 */

import type { AwarenessSource } from '@blockexpanse/sync';
