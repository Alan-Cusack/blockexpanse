...
import { type Disposable, Slot } from '@blockexpanse/global/utils';
...
export class Doc {
  ...
  addBlock<Key extends BlockExpanse.Flavour>(
    flavour: Key,
    blockProps?: BlockExpanse.ModelProps<BlockExpanse.BlockModels[Key]>,
  ...
  getSchemaByFlavour(flavour: BlockExpanse.Flavour) {
