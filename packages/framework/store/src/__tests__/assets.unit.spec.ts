import { BlockExpanseError } from '@blockexpanse/global/exceptions';
...
describe('getAssetName', () => {
  ...
  test('should throw BlockExpanseError if blob is not found', () => {
    const assets = new Map<string, Blob>();
    expect(() => getAssetName(assets, 'blobId')).toThrow(BlockExpanseError);
