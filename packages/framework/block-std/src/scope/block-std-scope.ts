import type { ServiceProvider } from '@blockexpanse/global/di';
import type { Doc } from '@blockexpanse/store';

import { Container } from '@blockexpanse/global/di';
...
export class BlockStdScope {
  ...
  getConfig<Key extends BlockExpanse.ConfigKeys>(
    flavour: Key
  ): BlockExpanse.BlockConfigs[Key] | null;
   ...
   */
  getService<Key extends BlockExpanse.ServiceKeys>(
    flavour: Key
  ): BlockExpanse.BlockServices[Key] | null;
