...
import {
  ...
  ErrorCode,
  handleError,
} from '@blockexpanse/global/exceptions';
import {
  SignalWatcher,
  Slot,
  WithDisposable,
} from '@blockexpanse/global/utils';
import { Doc } from '@blockexpanse/store';
import { type BlockModel, BlockViewType } from '@blockexpanse/store';
...
export class EditorHost extends SignalWatcher(
  ...
  /**
   * @deprecated
   * Render a block model manually instead of let blockexpanse render it.
