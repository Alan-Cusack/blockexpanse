...
import { EdgelessRootService, EditPropsStore } from '@blockexpanse/blocks';
...
export class FramesSettingMenu extends WithDisposable(LitElement) {
  ...
  override render() {
    const t =
      this.editorHost.std.getOptional(I18nProvider)?.t ?? identityI18nFn;
    return html`<div
    ...
    >
      <div class="frames-setting-menu-item">
        <div class="setting-label">
          ${t(I18nKeys.editor.framePanel.previewSettings, 'Preview Settings')}
        </div>
      </div>
      <div class="frames-setting-menu-item action">
        <div class="action-label">
          ${t(I18nKeys.editor.framePanel.fillScreen, 'Fill Screen')}
        </div>
      ...
      <div class="frames-setting-menu-item">
        <div class="setting-label">
          ${t(I18nKeys.editor.framePanel.playbackSettings, 'Playback Settings')}
        </div>
      </div>
      <div class="frames-setting-menu-item action">
        <div class="action-label">
          ${t(I18nKeys.editor.framePanel.darkBackground, 'Dark background')}
        </div>
        <div class="toggle-button">
          <toggle-switch
      ...
      <div class="frames-setting-menu-item action">
        <div class="action-label">
          ${t(I18nKeys.editor.framePanel.hideToolbar, 'Hide toolbar')}
        </div>
        <div class="toggle-button">
          <toggle-switch
            .on=${this.hideToolbar}
