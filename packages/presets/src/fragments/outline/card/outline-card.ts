  ...
  private _getCurrentModeLabel(mode: NoteDisplayMode) {
    ...
    switch (mode) {
      case NoteDisplayMode.DocAndEdgeless:
        return t(I18nKeys.editor.outline.both, 'Both');
      case NoteDisplayMode.EdgelessOnly:
        return t(I18nKeys.editor.outline.edgeless, 'Edgeless');
      case NoteDisplayMode.DocOnly:
        return t(I18nKeys.editor.outline.page, 'Page');
      default:
        return t(I18nKeys.editor.outline.both, 'Both');
    }
  }
        ...
        ${html`<div class=${cardHeaderClasses}>
          ...
          <div class="display-mode-button-group">
            <span class="display-mode-button-label"
              >${resolveI18nFn()(
                I18nKeys.editor.outline.showIn,
                'Show in'
              )}</span
            >
            <edgeless-tool-icon-button
              .tooltip=${
                this._showPopper
                  ? ''
                  : resolveI18nFn()(
                      I18nKeys.editor.outline.displayMode,
                      'Display Mode'
                    )
              }
