...
import { PropTypes, requiredProperties } from '@blockexpanse/block-std';
import { NoteDisplayMode, scrollbarStyle } from '@blockexpanse/blocks';
    ...
    const toggleOutlinePanelButton =
      this.toggleOutlinePanel !== null
        ? html`<edgeless-tool-icon-button
            .tooltip=${t(
              I18nKeys.editor.outline.openInSidebar,
              'Open in sidebar'
            )}
            .tipPosition=${'top-end'}
