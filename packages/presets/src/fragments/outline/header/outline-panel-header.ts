...
import { createButtonPopper } from '@blockexpanse/blocks';
  ...
  override render() {
    ...
    return html`<div class="outline-panel-header-container">
        <div class="note-setting-container">
          <span class="outline-panel-header-label"
            >${t(
              I18nKeys.editor.outline.tableOfContents,
              'Table of Contents'
            )}</span
          >
          <edgeless-tool-icon-button
            ...
            .tooltip=${this._settingPopperShow
              ? ''
              : t(I18nKeys.editor.outline.previewSettings, 'Preview Settings')}
            .tipPosition=${'bottom'}
        ...
        <edgeless-tool-icon-button
          ...
          .tooltip=${t(
            I18nKeys.editor.outline.visibilityAndSort,
            'Visibility and sort'
          )}
          .tipPosition=${'left'}
