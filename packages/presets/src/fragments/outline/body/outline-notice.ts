  ...
  override render() {
    ...
    return html`<div class="outline-notice-container">
      <div class="outline-notice-header">
        <span class="outline-notice-label"
          >${t(
            I18nKeys.editor.outline.someContentsHidden,
      ...
      <div class="outline-notice-body">
        <div class="outline-notice-item notice">
          ${t(
            I18nKeys.editor.outline.noticeEdgeless,
        ...
        >
          <span
            >${t(
              I18nKeys.editor.outline.noticeClickHere,
              'Click here or'
            )}</span
          >
          ...
          <span
            >${t(
              I18nKeys.editor.outline.noticeOrganize,
              'to organize content.'
            )}</span
          >
        </div>
