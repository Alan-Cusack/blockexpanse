...
import { type BlockModel, type Doc, DocCollection } from '@blockexpanse/store';
...
describe('index generator', () => {
  let preinsertedShape: BlockExpanse.SurfaceElementModel;
  ...
  beforeEach(() => {
    ...
    preinsertedShape = service.getElementById(
      shapeId
    )! as BlockExpanse.SurfaceElementModel;
