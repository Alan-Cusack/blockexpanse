...
import { NoteDisplayMode } from '@blockexpanse/affine-model';
import {
  DocModeProvider,
  I18nKeys,
  I18nProvider,
...
export function promptDocTitle(host: EditorHost, autofill?: string) {
  ...
  return notification.prompt({
    title: t(I18nKeys.editor.common.createLinkedDoc, 'Create linked doc'),
    message: t(
      I18nKeys.editor.common.enterDocTitle,
      'Enter a title for the new doc.'
    ),
    placeholder: t(I18nKeys.editor.common.untitled, 'Untitled'),
    autofill,
    confirmText: t(I18nKeys.editor.common.confirm, 'Confirm'),
