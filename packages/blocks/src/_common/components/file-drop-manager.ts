import type { DragIndicator } from '@blockexpanse/affine-components/drag-indicator';
import type { BlockService, EditorHost } from '@blockexpanse/block-std';
...
import { assertExists, Point } from '@blockexpanse/global/utils';
