...
import type { Viewport } from '@blockexpanse/affine-shared/types';
import type { PointerEventState } from '@blockexpanse/block-std';
import type { BlockModel, Text } from '@blockexpanse/store';

import { focusTextModel } from '@blockexpanse/affine-components/rich-text';
