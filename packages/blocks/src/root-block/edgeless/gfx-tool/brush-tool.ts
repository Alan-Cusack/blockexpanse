import type { BrushElementModel } from '@blockexpanse/affine-model';
import type { PointerEventState } from '@blockexpanse/block-std';
import type { IVec } from '@blockexpanse/global/utils';

import { CanvasElementType } from '@blockexpanse/affine-block-surface';
