...
import { Bound, type IVec } from '@blockexpanse/global/utils';
...
export class EraserTool extends BaseTool {
  ...
  private _erasable = new Set<BlockExpanse.EdgelessModel>();

  private _eraserPoints: IVec[] = [];

  private _eraseTargets = new Set<BlockExpanse.EdgelessModel>();
