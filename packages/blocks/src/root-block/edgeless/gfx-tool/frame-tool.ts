import type { FrameBlockModel } from '@blockexpanse/affine-model';
import type { PointerEventState } from '@blockexpanse/block-std';
import type { IPoint, IVec } from '@blockexpanse/global/utils';

import { OverlayIdentifier } from '@blockexpanse/affine-block-surface';
import { TelemetryProvider } from '@blockexpanse/affine-shared/services';
import {
  BaseTool,
  getTopElements,
  GfxExtensionIdentifier,
} from '@blockexpanse/block-std/gfx';
import { Bound, Vec } from '@blockexpanse/global/utils';
