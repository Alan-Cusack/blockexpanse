...
import type { GfxController } from '@blockexpanse/block-std/gfx';
...
export class EdgelessSnapManager extends Overlay {
  ...
  setupAlignables(
    alignables: BlockExpanse.EdgelessModel[],
    exclude: BlockExpanse.EdgelessModel[] = []
  ): Bound {
