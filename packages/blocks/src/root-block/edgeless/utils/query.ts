...
import type { PointLocation } from '@blockexpanse/global/utils';
...
export function isMindmapNode(
  element: GfxBlockModel | BlockExpanse.EdgelessModel | null
) {
  return element?.group instanceof MindmapElementModel;
}

export function isTopLevelBlock(
  selectable: BlockModel | BlockExpanse.EdgelessModel | null
): selectable is GfxBlockModel {
  return !!selectable && 'flavour' in selectable;
}

export function isNoteBlock(
  element: BlockModel | BlockExpanse.EdgelessModel | null
...
export function isConnectable(
  element: BlockExpanse.EdgelessModel | null
...
export function getSelectedRect(
  selected: BlockExpanse.EdgelessModel[]
): DOMRect {
