...
import type { XYWH } from '@blockexpanse/global/utils';
...
import { captureEventTarget } from '@blockexpanse/affine-shared/utils';
import { type BlockStdScope, stdContext } from '@blockexpanse/block-std';
...
export class EdgelessAutoCompletePanel extends WithDisposable(LitElement) {
  ...
  override render() {
    ...
    return html`<div class="auto-complete-panel-container" style=${style}>
      ...
      <edgeless-tool-icon-button
        .tooltip=${t(I18nKeys.editor.edgeless.text, 'Text')}
      ...
      <edgeless-tool-icon-button
        .tooltip=${t(I18nKeys.editor.edgeless.note, 'Note')}
      ...
      <edgeless-tool-icon-button
        .tooltip=${t(I18nKeys.editor.edgeless.frame, 'Frame')}
