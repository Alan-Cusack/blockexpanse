  ...
  return html`
    <div class="connector-mode-button-group">
      <edgeless-tool-icon-button
        ...
        .tooltip=${t(I18nKeys.editor.edgeless.connectorTools.curve, 'Curve')}
      ...
      <edgeless-tool-icon-button
        ...
        .activeMode=${'background'}
        .tooltip=${t(
          I18nKeys.editor.edgeless.connectorTools.elbowed,
          'Elbowed'
        )}
      ...
      <edgeless-tool-icon-button
        ...
        .activeMode=${'background'}
        .tooltip=${t(
          I18nKeys.editor.edgeless.connectorTools.straight,
          'Straight'
        )}
