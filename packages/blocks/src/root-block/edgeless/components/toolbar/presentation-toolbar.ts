...
export class PresentationToolbar extends EdgelessToolbarToolMixin(
  ...
  private _nextFrame() {
    ...
    if (this._currentFrameIndex === frames.length - 1) {
      toastI18n(
        this.host,
        I18nKeys.editor.toast.lastFrame,
  ...
  private _previousFrame() {
    ...
    if (this._currentFrameIndex === 0) {
      toastI18n(
        this.host,
        I18nKeys.editor.toast.firstFrame,
      ...
      effect(() => {
        ...
        if (currentTool?.type === 'frameNavigator') {
          ...
          if (this._frames.length === 0)
            toastI18n(
              this.host,
              I18nKeys.editor.toast.presentationNeedFrame,
  ...
  override render() {
    ...
    return html`
      ...
      <edgeless-tool-icon-button
        ...
        .tooltip=${t(I18nKeys.editor.edgeless.previous, 'Previous')}
      ...
      <edgeless-tool-icon-button
        .tooltip=${t(I18nKeys.editor.edgeless.next, 'Next')}
