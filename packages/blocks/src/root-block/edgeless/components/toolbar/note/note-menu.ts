        ...
        <div class="menu-content">
          ...
          <div class="button-group-container">
            <edgeless-tool-icon-button
              ...
              .tooltip=${t(I18nKeys.editor.slash.image, 'Image')}
            ...
            <edgeless-tool-icon-button
              .activeMode=${'background'}
              .tooltip=${getTooltipWithShortcut(
                t(I18nKeys.editor.edgeless.link, 'Link'),
                '@'
              )}
              @click=${() => {
            ...
            <edgeless-tool-icon-button
              .activeMode=${'background'}
              .tooltip=${t(I18nKeys.editor.edgeless.noteTools.file, 'File')}
              @click=${async () => {
            ...
            ${repeat(
              ...
              item => html`
                <edgeless-tool-icon-button
                  ...
                  .activeMode=${'background'}
                  .tooltip=${translateSlashLabel(t, item.tooltip)}
                  @click=${() =>
                    this.onChange({
