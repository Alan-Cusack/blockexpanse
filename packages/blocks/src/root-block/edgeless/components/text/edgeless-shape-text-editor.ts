...
import type { ShapeElementModel } from '@blockexpanse/affine-model';

import { CommonUtils, TextUtils } from '@blockexpanse/affine-block-surface';
import { MindmapElementModel, TextResizing } from '@blockexpanse/affine-model';
