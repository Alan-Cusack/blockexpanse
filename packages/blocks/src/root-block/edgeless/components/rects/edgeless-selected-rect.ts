...
> {
  ...
  get resizeMode(): ResizeMode {
    ...
    for (const element of elements) {
      if (isNoteBlock(element) || isEmbedSyncedDocBlock(element)) {
        ...
        assertType<BlockExpanse.SurfaceElementModel>(element);
  ...
  private _isProportionalElement(element: BlockExpanse.EdgelessModel) {
    return (
  ...
  private _shouldRenderSelection(elements?: BlockExpanse.EdgelessModel[]) {
