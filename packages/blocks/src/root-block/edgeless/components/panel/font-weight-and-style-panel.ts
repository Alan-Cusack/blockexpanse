import { TextUtils } from '@blockexpanse/affine-block-surface';
import { CheckIcon } from '@blockexpanse/affine-components/icons';
import {
  FontFamily,
  FontFamilyMap,
  FontStyle,
...
const FONT_WEIGHT_I18N_KEYS: [FontWeight, string, string][] = [
  [FontWeight.Light, I18nKeys.editor.edgeless.textTools.light, 'Light'],
  [FontWeight.Regular, I18nKeys.editor.edgeless.textTools.regular, 'Regular'],
  [
    FontWeight.SemiBold,
    I18nKeys.editor.edgeless.textTools.semibold,
    'Semibold',
  ],
];
...
export class EdgelessFontWeightAndStylePanel extends LitElement {
  ...
  override render() {
    ...
    const fontWeightChoose: [FontWeight, () => string][] =
      FONT_WEIGHT_I18N_KEYS.map(([weight, i18nKey, fallback]) => [
        weight,
        () => t(i18nKey, fallback),
      ]);
    const italicLabel = t(I18nKeys.editor.edgeless.textTools.italic, 'Italic');
          ...
          ? repeat(
              ...
              fontFace => {
                ...
                return html`
                  ...
                  >
                    ${choose(fontFace.weight, fontWeightChoose)}
          ...
          ? repeat(
              ...
              fontFace => {
                ...
                return html`
                  ...
                  >
                    ${choose(fontFace.weight, fontWeightChoose)} ${italicLabel}
                    ${active ? CheckIcon : nothing}
                  </edgeless-tool-icon-button>
                `;
              }
