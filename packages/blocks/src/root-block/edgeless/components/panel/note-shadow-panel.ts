...
import { ColorScheme, NoteShadow } from '@blockexpanse/affine-model';
import {
  I18nKeys,
  I18nProvider,
  identityI18nFn,
...
const ShadowTooltipI18nKeyMap: Record<NoteShadow, string> = {
  [NoteShadow.None]: I18nKeys.editor.edgeless.noteTools.shadowNone,
  [NoteShadow.Box]: I18nKeys.editor.edgeless.noteTools.shadowBox,
  [NoteShadow.Sticker]: I18nKeys.editor.edgeless.noteTools.shadowSticker,
  [NoteShadow.Paper]: I18nKeys.editor.edgeless.noteTools.shadowPaper,
  [NoteShadow.Float]: I18nKeys.editor.edgeless.noteTools.shadowFloat,
  [NoteShadow.Film]: I18nKeys.editor.edgeless.noteTools.shadowFilm,
};
        ...
        html`<style>
          ...
          >
            <edgeless-tool-icon-button
              class="item-icon"
              .tooltip=${t(
                ShadowTooltipI18nKeyMap[shadow.type],
                shadow.tooltip
              )}
              .tipPosition=${'bottom'}
