import { SHAPE_STROKE_COLORS, StrokeStyle } from '@blockexpanse/affine-model';
import {
  I18nKeys,
  I18nProvider,
  identityI18nFn,
...
export class StrokeStylePanel extends WithDisposable(LitElement) {
  ...
  override render() {
    ...
    const borderColorsLabel = t(
      I18nKeys.editor.edgeless.shapeTools.borderColors,
      'Border colors'
    );
