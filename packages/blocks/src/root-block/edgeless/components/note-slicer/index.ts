import { SmallScissorsIcon } from '@blockexpanse/affine-components/icons';
import { DEFAULT_NOTE_HEIGHT } from '@blockexpanse/affine-model';
import { EDGELESS_BLOCK_CHILD_PADDING } from '@blockexpanse/affine-shared/consts';
import { TelemetryProvider } from '@blockexpanse/affine-shared/services';
import { getRectByBlockComponent } from '@blockexpanse/affine-shared/utils';
import { WidgetComponent } from '@blockexpanse/block-std';
import { GfxControllerIdentifier } from '@blockexpanse/block-std/gfx';
import {
  deserializeXYWH,
  DisposableGroup,
  Point,
