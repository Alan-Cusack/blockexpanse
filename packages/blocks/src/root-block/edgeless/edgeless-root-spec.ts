...
import { AFFINE_SCROLL_ANCHORING_WIDGET } from '@blockexpanse/affine-widget-scroll-anchoring';
import {
  BlockViewExtension,
  CommandExtension,
  type ExtensionType,
...
import { BlockServiceWatcher, FlavourExtension } from '@blockexpanse/block-std';
import { ToolController } from '@blockexpanse/block-std/gfx';
...
import { AFFINE_EDGELESS_COPILOT_WIDGET } from '../widgets/edgeless-copilot/index.js';
