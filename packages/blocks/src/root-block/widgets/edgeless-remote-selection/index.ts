...
import type { UserInfo } from '@blockexpanse/store';

import { RemoteCursor } from '@blockexpanse/affine-components/icons';
import { requestThrottledConnectedFrame } from '@blockexpanse/affine-shared/utils';
import { WidgetComponent } from '@blockexpanse/block-std';
import { assertExists, pickValues } from '@blockexpanse/global/utils';
    ...
    remoteSelectionsMap.forEach((selections, clientId) => {
      selections.forEach(selection => {
        ...
        const elements = selection.elements
          ...
          .filter(element => element) as BlockExpanse.EdgelessModel[];
