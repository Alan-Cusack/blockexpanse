import type { AffineInlineEditor } from '@blockexpanse/affine-components/rich-text';

import { ArrowDownIcon } from '@blockexpanse/affine-components/icons';
import { createLitPortal } from '@blockexpanse/affine-components/portal';
import { getInlineEditorByModel } from '@blockexpanse/affine-components/rich-text';
import {
  I18nProvider,
  identityI18nFn,
  translateSlashLabel,
    ...
    >
      ...
      >
        ...
        <div class="tooltip-caption">
          ${translateSlashLabel(
            this.context.rootComponent.host.std.getOptional(I18nProvider)?.t ??
              identityI18nFn,
            tooltip.caption
          )}
        </div>
