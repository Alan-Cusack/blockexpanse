  ...
  override render() {
    ...
    if (this._loading) {
      return html`
        ...
        <div class="container">
          ...
          >
            <div>${t(I18nKeys.editor.importDoc.title, 'Import')}</div>
            <loader-element .width=${'50px'}></loader-element>
          </header>
          <div>
            ${t(
              I18nKeys.editor.importDoc.loadingHint,
    ...
    return html`
      ...
      <div class="container">
        ...
        <div>
          ${t(
            I18nKeys.editor.importDoc.supportMore,
          ...
          <a
            ...
            target="_blank"
            >${t(
              I18nKeys.editor.importDoc.provideFeedback,
              'Provide feedback.'
            )}</a
          >
        </div>
        ...
        <div class="button-container">
          ...
          >
            ...
            >
              ...
              <affine-tooltip>
                ${t(
                  I18nKeys.editor.importDoc.learnNotion,
          ...
          <icon-button
            class="button-item"
            text=${t(I18nKeys.editor.importDoc.comingSoon, 'Coming soon...')}
            disabled
          >
            ${NewIcon}
          </icon-button>
