import type { ParagraphBlockModel } from '@blockexpanse/affine-model';
import type {
  BaseSelection,
  BlockComponent,
  EditorHost,
...
import { ParagraphBlockComponent } from '@blockexpanse/affine-block-paragraph';
import { BLOCK_CHILDREN_CONTAINER_PADDING_LEFT } from '@blockexpanse/affine-shared/consts';
import {
  DocModeProvider,
  type DropType,
...
import { Point, Rect } from '@blockexpanse/global/utils';
