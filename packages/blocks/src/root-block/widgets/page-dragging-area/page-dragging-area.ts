...
import { BLOCK_ID_ATTR, type PointerEventState } from '@blockexpanse/block-std';
import { BlockComponent, WidgetComponent } from '@blockexpanse/block-std';
import { assertInstanceOf } from '@blockexpanse/global/utils';
