    ...
    return html`
      ...
      >
        <edgeless-tool-icon-button
          .tooltip=${t(I18nKeys.editor.edgeless.fitToScreen, 'Fit to screen')}
        ...
        <edgeless-tool-icon-button
          .tooltip=${t(I18nKeys.editor.edgeless.zoomOut, 'Zoom out')}
        ...
        <edgeless-tool-icon-button
          .tooltip=${t(I18nKeys.editor.edgeless.zoomIn, 'Zoom in')}
          .tipPosition=${this._isVerticalBar() ? 'right' : 'top'}
          .arrow=${!this._isVerticalBar()}
          @click=${() => this.edgelessService.setZoomByStep(ZOOM_STEP)}
          .iconContainerPadding=${4}
