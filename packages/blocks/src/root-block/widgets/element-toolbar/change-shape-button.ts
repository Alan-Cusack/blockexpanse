...
export class EdgelessChangeShapeButton extends WithDisposable(LitElement) {
  ...
  override render() {
    ...
    const switchTypeLabel = t(
      I18nKeys.editor.edgeless.shapeTools.switchType,
      'Switch type'
    );
    const styleLabel = t(I18nKeys.editor.edgeless.style, 'Style');
    const fillColorLabel = t(
      I18nKeys.editor.edgeless.shapeTools.fillColor,
      'Fill color'
    );
    const borderStyleLabel = t(
      I18nKeys.editor.edgeless.shapeTools.borderStyle,
      'Border style'
    );
      ...
      [
        html`
          <editor-menu-button
            .button=${html`
              <editor-icon-button
                aria-label=${switchTypeLabel}
                .tooltip=${switchTypeLabel}
              >
        ...
        when(
          ...
          () => html`
            <editor-menu-button
              ...
              .button=${html`
                <editor-icon-button
                  aria-label=${fillColorLabel}
                  .tooltip=${fillColorLabel}
                >
