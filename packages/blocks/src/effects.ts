...
import { effects as blockEmbedEffects } from '@blockexpanse/affine-block-embed/effects';
import { effects as blockListEffects } from '@blockexpanse/affine-block-list/effects';
import { effects as blockParagraphEffects } from '@blockexpanse/affine-block-paragraph/effects';
import { effects as blockSurfaceEffects } from '@blockexpanse/affine-block-surface/effects';
import { effects as componentCaptionEffects } from '@blockexpanse/affine-components/caption';
import { effects as componentContextMenuEffects } from '@blockexpanse/affine-components/context-menu';
import { effects as componentDatePickerEffects } from '@blockexpanse/affine-components/date-picker';
import { effects as componentDragIndicatorEffects } from '@blockexpanse/affine-components/drag-indicator';
import { effects as componentPortalEffects } from '@blockexpanse/affine-components/portal';
import { effects as componentRichTextEffects } from '@blockexpanse/affine-components/rich-text';
import { effects as componentToggleButtonEffects } from '@blockexpanse/affine-components/toggle-button';
import { effects as componentToolbarEffects } from '@blockexpanse/affine-components/toolbar';
import { effects as widgetScrollAnchoringEffects } from '@blockexpanse/affine-widget-scroll-anchoring/effects';
import { effects as stdEffects } from '@blockexpanse/block-std/effects';
import { effects as dataViewEffects } from '@blockexpanse/data-view/effects';
import { effects as inlineEffects } from '@blockexpanse/inline/effects';
...
import { effects as blockTableEffects } from './table-block/effects.js';
