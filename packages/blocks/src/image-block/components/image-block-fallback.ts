...
import { modelContext, ShadowlessElement } from '@blockexpanse/block-std';
...
export class ImageBlockFallbackCard extends WithDisposable(ShadowlessElement) {
  ...
  override render() {
    ...
    const titleText = loading
      ? t(I18nKeys.editor.embed.loadingImage, 'Loading image...')
      : error
        ? t(I18nKeys.editor.embed.imageLoadFailed, 'Image loading failed.')
        : t(I18nKeys.editor.embed.image, 'Image');
