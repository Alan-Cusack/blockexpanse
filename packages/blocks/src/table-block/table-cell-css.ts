...
export const columnOptionsStyle = css({
  ...
  width: '28px',
  height: '16px',
  backgroundColor: tableTheme.headerBackgroundDefault,
  borderRadius: '8px',
  ...
  alignItems: 'center',
  justifyContent: 'center',
  '--three-pointer-icon-color': tableTheme.indicatorPointerDefault,
  ':hover': {
    opacity: 1,
  },
  '&.active': {
    ...
    '--three-pointer-icon-color': tableTheme.indicatorPointerActive,
  },
});
