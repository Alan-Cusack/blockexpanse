import type { CanvasRenderer } from '@blockexpanse/affine-block-surface';
...
import { SpecProvider } from '@blockexpanse/affine-shared/utils';
import {
  BlockStdScope,
  type EditorHost,
...
import { deserializeXYWH, WithDisposable } from '@blockexpanse/global/utils';
import {
  type BlockModel,
  BlockViewType,
  type Query,
