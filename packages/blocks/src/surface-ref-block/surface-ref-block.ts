import type { BlockCaptionEditor } from '@blockexpanse/affine-components/caption';
...
import { Peekable } from '@blockexpanse/affine-components/peek';
import {
  FrameBlockModel,
  GroupElementModel,
...
import { BlockComponent, BlockServiceWatcher } from '@blockexpanse/block-std';
import { GfxBlockElementModel } from '@blockexpanse/block-std/gfx';
...
> {
  ...
  private _referencedModel: BlockExpanse.EdgelessModel | null = null;
  ...
  private _renderMask(
    referencedModel: BlockExpanse.EdgelessModel,
  ...
  private _renderRefContent(referencedModel: BlockExpanse.EdgelessModel) {
