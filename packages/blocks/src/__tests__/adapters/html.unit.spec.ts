...
import { AssetsManager, MemoryBlobCRUD } from '@blockexpanse/store';
...
describe('snapshot to html', () => {
  ...
  <body>
  <div style="width: 70vw; margin: 60px auto;"><!--BlockExpanseDocTitlePlaceholder-->
  <!--HtmlTemplate-->
  </div>
  </body>
  </html>
  `
    ...
    if (title) {
      htmlTemplate = htmlTemplate.replace(
        '<!--BlockExpanseDocTitlePlaceholder-->',
        `<h1>${title}</h1>`
      );
    }
    return htmlTemplate;
  ...
  describe('embed link block', () => {
    const embedTestCases = [
      ...
      },
      {
        ...
        url: 'https://github.com/Alan-Cusack/blockexpanse/pull/66666',
