import type { HoverController } from '@blockexpanse/affine-components/hover';

import { AttachmentBlockStyles } from '@blockexpanse/affine-model';
import {
  EMBED_CARD_HEIGHT,
  EMBED_CARD_WIDTH,
} from '@blockexpanse/affine-shared/consts';
import { toGfxBlockComponent } from '@blockexpanse/block-std';
