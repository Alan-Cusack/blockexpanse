...
import type { SerializedXYWH } from '@blockexpanse/global/utils';
import type { DeltaInsert } from '@blockexpanse/inline/types';
...
import { type DocCollection, Job, Text } from '@blockexpanse/store';
...
function getDarkModeConfig(): boolean {
  const updatedDarkModeConfig = localStorage.getItem('blockexpanse:dark');
