...
export function sourcemapExclude(): Plugin {
  return {
    ...
    transform(code: string, id: string) {
      if (id.includes('node_modules') && !id.includes('@blockexpanse')) {
        return {
          code,
...
const chunkGroups = {
  framework: [
    require.resolve('@blockexpanse/block-std'),
    require.resolve('@blockexpanse/block-std/gfx'),
    require.resolve('@blockexpanse/global'),
    require.resolve('@blockexpanse/global/utils'),
    require.resolve('@blockexpanse/global/env'),
    require.resolve('@blockexpanse/global/exceptions'),
    require.resolve('@blockexpanse/global/di'),
    require.resolve('@blockexpanse/inline'),
    require.resolve('@blockexpanse/store'),
    require.resolve('@blockexpanse/sync'),
  ],
  components: [
    require.resolve('@blockexpanse/affine-components/icons'),
    require.resolve('@blockexpanse/affine-components/peek'),
    require.resolve('@blockexpanse/affine-components/portal'),
    require.resolve('@blockexpanse/affine-components/hover'),
    require.resolve('@blockexpanse/affine-components/toolbar'),
    require.resolve('@blockexpanse/affine-components/toast'),
    require.resolve('@blockexpanse/affine-components/rich-text'),
    require.resolve('@blockexpanse/affine-components/caption'),
    require.resolve('@blockexpanse/affine-components/context-menu'),
    require.resolve('@blockexpanse/affine-components/date-picker'),
    require.resolve('@blockexpanse/affine-components/drag-indicator'),
  ],
  affine: [
    require.resolve('@blockexpanse/affine-shared'),
    require.resolve('@blockexpanse/affine-model'),
    require.resolve('@blockexpanse/affine-block-list'),
    require.resolve('@blockexpanse/affine-block-paragraph'),
    require.resolve('@blockexpanse/affine-block-surface'),
    require.resolve('@blockexpanse/data-view'),
  ],
  ...
  blocks: [
    require.resolve('@blockexpanse/blocks'),
    require.resolve('@blockexpanse/blocks/schemas'),
  ],
