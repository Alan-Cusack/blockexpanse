import type { Point, Rect } from '@blockexpanse/global/utils';

import { BLOCK_ID_ATTR, type BlockComponent } from '@blockexpanse/block-std';
...
function isRootOrNoteOrSurface(element: BlockComponent) {
  return matchFlavours(element.model, [
    'affine:page',
    'affine:note',
    // @ts-ignore TODO: migrate surface model to @blockexpanse/affine-model
    'affine:surface',
  ]);
}
 ...
 * https://github.com/Alan-Cusack/blockexpanse/issues/902
 * https://github.com/Alan-Cusack/blockexpanse/pull/1121
 */
