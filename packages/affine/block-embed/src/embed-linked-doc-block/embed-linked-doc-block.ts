...
import { isPeekable, Peekable } from '@blockexpanse/affine-components/peek';
import {
  REFERENCE_NODE,
...
export class EmbedLinkedDocBlockComponent extends EmbedBlockComponent<EmbedLinkedDocModel> {
  ...
  get docTitle() {
    ...
    return (
      ...
      t(I18nKeys.editor.common.untitled, 'Untitled')
    );
  }
  ...
  override renderBlock() {
    ...
    const defaultNoteContent = isError
      ? t(
          I18nKeys.editor.embed.linkedDocFailed,
      ...
      : isLoading
        ...
        : isDeleted
          ? t(
              I18nKeys.editor.embed.linkedDocDeleted,
              'This linked doc is deleted.'
            )
          : isEmpty
            ? t(
                I18nKeys.editor.embed.previewDoc,
            ...
            ${isError
              ? html`
                  <div class="affine-embed-linked-doc-card-content-reload">
                    ...
                    >
                      ${ReloadIcon}
                      <span>${t(I18nKeys.editor.action.reload, 'Reload')}</span>
                    </div>
                  </div>
                `
              : html`
                  <div class="affine-embed-linked-doc-content-date">
                    <span>${t(I18nKeys.editor.common.updated, 'Updated')}</span>
