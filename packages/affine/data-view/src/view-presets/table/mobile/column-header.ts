    ...
    return html`
      ...
      >
        <uni-lit
          ...
          .uni="${column.icon}"
        ></uni-lit>
        <div class="mobile-table-column-header-name">
          ${tr(column.name$.value)}
        </div>
      </div>
    `;
  }
