...
import { DeleteIcon } from '@blockexpanse/icons/lit';
    ...
    options: {
      ...
      items: [
        menu.group({
          items: [
            menu.subMenu({
              name: t()(I18nKeys.editor.dataView.groupMenu.groupBy, 'Group By'),
              postfix: html`
                <div
                  ...
                  class="dv-icon-16"
                >
                  ${renderUniLit(icon, {})} ${tr(groupProperty.name$.value)}
                </div>
              `,
              label: () => html`
                <div style="color: var(--affine-text-secondary-color);">
                  ${t()(I18nKeys.editor.dataView.groupMenu.groupBy, 'Group By')}
                </div>
              `,
        ...
        menu.group({
          items: [
            menu.action({
              name: t()(
                I18nKeys.editor.dataView.groupMenu.removeGrouping,
                'Remove grouping'
              ),
              prefix: DeleteIcon(),
              class: { 'delete-item': true },
