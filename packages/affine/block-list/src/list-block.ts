import type { ListBlockModel } from '@blockexpanse/affine-model';
import type { BaseSelection, BlockComponent } from '@blockexpanse/block-std';
import type { InlineRangeProvider } from '@blockexpanse/inline';

import { CaptionedBlockComponent } from '@blockexpanse/affine-components/caption';
import { playCheckAnimation } from '@blockexpanse/affine-components/icons';
import {
  DefaultInlineManagerExtension,
  type RichText,
} from '@blockexpanse/affine-components/rich-text';
import '@blockexpanse/affine-shared/commands';
import { TOGGLE_BUTTON_PARENT_CLASS } from '@blockexpanse/affine-components/toggle-button';
import {
