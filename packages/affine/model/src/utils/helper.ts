import type { GfxCompatibleProps } from '@blockexpanse/block-std/gfx';
import type { Constructor } from '@blockexpanse/global/utils';

import { GfxCompatible } from '@blockexpanse/block-std/gfx';
import {
