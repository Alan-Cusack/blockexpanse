...
import type { Bound, SerializedXYWH, XYWH } from '@blockexpanse/global/utils';
...
export type MindmapNode = {
  ...
  element: BlockExpanse.SurfaceElementModel;
...
export class MindmapElementModel extends GfxGroupLikeElementModel<MindmapElementProps> {
  ...
  stashTree(node: MindmapNode | string) {
    ...
    const stashed = new Set<BlockExpanse.SurfaceElementModel>();
