import type { BaseElementProps } from '@blockexpanse/block-std/gfx';
import type { IVec, SerializedXYWH } from '@blockexpanse/global/utils';

import { field, GfxPrimitiveElementModel } from '@blockexpanse/block-std/gfx';
import {
  Bound,
...
import { DocCollection, type Y } from '@blockexpanse/store';
