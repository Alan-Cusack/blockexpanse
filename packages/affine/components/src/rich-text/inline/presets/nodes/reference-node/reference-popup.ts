...
import { assertExists, WithDisposable } from '@blockexpanse/global/utils';
    ...
    return html`
      <editor-menu-button
        ...
        .button=${html`
          ...
          >
            <span class="label"
              >${t(I18nKeys.editor.action.inlineView, 'Inline view')}</span
            >
            ${SmallArrowDownIcon}
          </editor-icon-button>
        `}
  ...
  override render() {
    ...
    const buttons = [
      ...
      html`
        ...
        <editor-icon-button
          aria-label=${t(I18nKeys.editor.action.copyLink, 'Copy link')}
