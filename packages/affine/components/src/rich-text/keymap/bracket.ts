...
import type { InlineEditor } from '@blockexpanse/inline';

import { BRACKET_PAIRS } from '@blockexpanse/affine-shared/consts';
import {
  createDefaultDoc,
  matchFlavours,
      ...
      return {
        ...
        [pair.left]: ctx => {
          ...
          if (!isCodeBlock && pair.name === 'square bracket') {
            ...
            // See https://github.com/Alan-Cusack/blockexpanse/issues/2730
