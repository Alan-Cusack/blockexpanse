# Building and Testing BlockExpanse

## Using Playground

To run BlockExpanse from source, please ensure you have installed [Node.js](https://nodejs.org/en/download) and [yarn](https://yarnpkg.com/).
...
And this would build the BlockExpanse packages:
...
To test the real-time collaboration feature of BlockExpanse locally, please follow these two simple steps:
...
See the [BlockExpanse upstream documentation](https://blockexpanse.io/guide/data-synchronization.html#document-streaming) about what's happening under the hood.
